...
<body>
	...
	<br>
	<img width="220" src="${location.image_url}"> ${location.name}
	<br>
		<c:choose>
		<c:when test="${!loggedInUser.hasRatedLocation(location.id)}">
		<a class="btn btn-update" href="giveLocationRating.do?locationId=${location.id}">
		...
		<br><a class="btn btn-danger" href="updateLocationPage.do?locationId=${location.id}">Update This Rumble Ring</a>
